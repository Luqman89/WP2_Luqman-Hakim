                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h1 mb-0 font-weight-bold text-white">
                                <?= $this->ModelUser->getUserWhere(
                                    ['role_id' => 1]
                                    )->num_rows(); ?>
                            </div>
                        </div>    
                            <div class="col-auto"> <a href="<?= base_url('user/anggota'); ?>">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h1 mb-0 font-weight-bold text-white">
                                ...
                                $total_dipinjam = $this->ModelBuku->total('dipinjam', $where);
                                echo $total_dipinjam; ?> 
                                </div>
                        </div>
                        ...
                        <div class="col mr-2">
                            <div class="text-md font-weight-bold text-white text-uppercase mb-1">
                                Buku yang dibooking
                                    ...
                                    $total_dibooking = $this->ModelBuku->total('dibooking', $where);
                                    echo $total_dibooking; ?> 
                                    </div>
                            </div>
                            <div class="col-auto"> <a href="<?= base_url('user'); ?>">
    ...
    <div class="row">
        ...
        <div class="table-responsive table-bordered col-sm-5 ml-auto mr-auto mt-2">
            <div class="page-header"> 
                ...
                <a href="<?= base_url('buku'); ?>"><i class="fas fa-search text-primary mt-2 float-right"> Tampilkan</i>
            </a> 
        </div>
